...
from storage.utils import get_test_number, get_pull_request_total, get_reviewer, get_comment_date_max_min,get_file_name
from storage.utils import get_pull_request_user, get_comment_user_and_date, get_pull_request_user_for_test,get_train_start_number
...
def main(project, train_time):
    ...
    for number, pull_request_user in test_info.items():
        try:
            ...
            Rp_viewers_all = {k: v for k, v in all_reviewer.items() if k < number}
            ...
            commented_user_1, commented_user_3, commented_user_5 = [commented_user[0]],commented_user[0:2],commented_user[0:5]
            #
